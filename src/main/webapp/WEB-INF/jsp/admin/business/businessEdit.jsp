...
<body>
	<form id="businessForm" name="businessForm" enctype="multipart/form-data" style="padding: 10px;">
			 ...
			 if(id) {
				...
				$.post(url, params, function(data) {
					editor.ready(function(){//监听编辑器实例化完成的事件
						$('#businessForm').find('#title').textbox('setValue', data.title);
						$('#businessForm').find('#id').val(id);
