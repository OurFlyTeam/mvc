...
<!--轮播大图-->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/js/owl.carousel.2.0.0-beta.2.4/assets/owl.carousel.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/js/owl.carousel.2.0.0-beta.2.4/assets/owl.theme.default.min.css" />
</head>
<!-- Main -->
<link rel="stylesheet" type="text/css"
...
<body>
	...
	<div class="banner">
		<div class="owl-carousel owl-theme">
			<div class="item">
				<img
					src="${pageContext.request.contextPath}/img/main_viewpictures/1.jpg"
					alt="公司俯瞰">
			</div>
			<!--
			<div class="item">
				<img
					src="${pageContext.request.contextPath}/img/main_viewpictures/2.jpg"
					alt="让山更青,让水更绿" />
			</div>
			-->
			...
			<div class="item">
				<img
					src="${pageContext.request.contextPath}/img/main_viewpictures/3.jpg"
					alt="公司大楼" />
			</div>
		</div>
	</div>
			...
			<div class="pro01">
				...
				<div class="projs projsdivq projsdivq0" style="display: block;">
					<div class="fl">
						<p class= "pnb">
							&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;青岛晟荣环境工程有限公司位于风光秀丽、气候宜人的滨海度假旅游城市及国际性港口城市、国家历史文化名城——青岛，坐落在即墨华骏物流园东，是集科研、设计、生产制造、营销、安装调试、售后服务为一体的专业环保企业。<br><br>
							&nbsp;&nbsp;&nbsp;&nbsp;
							...
							通过科研研发和技术创新，公司推出多种高品质的环保治理一体化设备。专业为各种行业的污水、废气处理，提供安全可靠的工艺技术设备和高效优质的工程服务。<br><br>
							&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;公司一贯坚持客户至上的服务理念，从项目设计、工程实施、运营及售后服务的每一个过程，都切实为客户着想，致力于打造精品工程、样板工程、惠民工程，为环保事业做出贡献。<br><br>
							&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<div class="projs projsdivq projsdivq1" style="display: none;">
					<div class="fl">
						...
						<p class= "pb">经营理念</p>
						<p class= "pnb">顾客至上 质量第一</p>
						<p class= "pb">企业精神</p>
						<p class= "pnb">科技创新 和谐共赢</p>

					</div>
					
					<div class="clear">
						<img src="${pageContext.request.contextPath}/img/company/company.jpg"
							alt="企业文化" />
					</div>
				</div>
			</div>
